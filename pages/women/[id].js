...
export default function Item({ women }) {
    ...
    return (
        <div>
            ...
            <p className='itemHeader_Main text-5xl '>{women.name}</p>
            <p className='font-light mt-4 text-4xl'>{women.category}</p>
            <p className='font-light mt-4 text-3xl'>${women.price}</p>
            <img className='ml-auto mr-auto mt-10 prodImg' src={women.images} />
