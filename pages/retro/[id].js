...
export default function Item({ retro }) {
    ...
    let price = retro.price
    // let quantity = retro.quantity
    ...
    return (
        <div>
            ...
            <p className='itemHeader_Main text-5xl '>{retro.name}</p>
            <p className='font-light mt-4 text-4xl'>{retro.category}</p>
            <p className='font-light mt-4 text-3xl'>${retro.price}</p>
            <img className='ml-auto mr-auto mt-10 prodImg' src={retro.images} />
